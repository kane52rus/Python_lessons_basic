...
# print("First task")
# number_list = [int(input("Введите первое число")), int(input("Введите второе число")), int(input("Введите третье число")), int(input("Введите четвертое число")), int(input("Введите пятое число")),]
# new_number_list = []
#
# for i in number_list:
#     if i >= 0 and int(math.sqrt(i)) == math.sqrt(i):
#         new_number_list.append(int(math.sqrt(i)))
#
...
for i in dict_days:
    if date_list[0] == i:
        date_list[0] = dict_days[i]
for i in dict_months:
    if date_list[1] == i:
        date_list[1] = dict_months[i]
x = f"{date_list[0]} {date_list[1]} {date_list[2]} года"
print(x)
